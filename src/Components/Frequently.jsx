  ...
  return (
    <div className="flex flex-col gap-16">
      <div className="flex lg:flex-row flex-col lg:gap-20 gap-5 lg:items-end lg:justify-start items-start">
        ...
        <button
          class="w-35 h-12.25 cursor-pointer inline-flex items-center rounded-md lg:px-3 px-5 lg:py-3.5 py-1.5 lg:text-[14px] text-[14px] font-mono font-semibold text-rose-600 hover:text-white border-2 border-rose-600
